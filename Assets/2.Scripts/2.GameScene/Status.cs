...
public class Status : MonoBehaviour {
    ...
    [SerializeField]
    private Sprite StatusWindowImage;
    [SerializeField]
    private Sprite OutsideNormalImage;
    [SerializeField]
    private Sprite OutsideFishingImage;
    [SerializeField]
    private Sprite OutsideWaterImage;
    [SerializeField]
    private Vector3 CharaMenuPos;
    ...
    public Sprite getStatusWindowImage( ) {
        return StatusWindowImage;
    }
